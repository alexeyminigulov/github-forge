...
import net.minilex.mocapmod.entity.animations.RhinoAnimationDefinitions;
...
public class RhinoModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animateWalk(RhinoAnimationDefinitions.RHINO_WALK, limbSwing, limbSwingAmount, 2f, 2.5f);
		this.animate(((RhinoEntity) entity).idleAnimationState, RhinoAnimationDefinitions.RHINO_IDLE, ageInTicks, 1f);
		this.animate(((RhinoEntity) entity).attackAnimationState, RhinoAnimationDefinitions.RHINO_ATTACK, ageInTicks, 1f);
	}
