...
public class CommandUtil {
    ...
    public ScriptObject getNextScriptElement() {
        if (this.scriptObjects == null) {
            ...
            return new ScriptObject(randomName, 12.0f, textureValue, signature);
        }
    ...
    private void getScriptElements(String scriptName) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.size(); i++) {
                ...
                this.scriptObjects[i] = new ScriptObject(name, health, skinValue, signature);
            }
    ...
    public class ScriptObject {
        ...
        public ScriptObject(String name, float health, String skinValue, String signature) {
            this.name = name;
            this.health = health;
